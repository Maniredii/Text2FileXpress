...
const Converter = () => {
  ...
  const handleGeneratePDF = () => {
    ...
    try {
      ...
      // Handle alignment (basic implementation for PDF)
      // jsPDF text alignment is done via options
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-between items-start mb-10">
            <div className="text-center flex-1">
                <h1 className={`text - 4xl font - extrabold sm: text - 5xl mb - 2 ${ darkMode ? 'text-white' : 'text-gray-900' } `}>
                    Text to PDF / DOCX
                </h1>
